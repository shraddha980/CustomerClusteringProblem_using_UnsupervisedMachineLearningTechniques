...
import pandas as pd
from Segmentation.utils import load_object
import os
import sys
...
def start_batch_prediction(input_file_path):
    try:
        ...
        df = pd.read_csv(r"E:\Insurance-Prediction-Project-main\bank-additional-full.csv", sep=";")
        ...
        logging.info(f"Loaded Target Encoder : {target_encoder}")
        ...
        logging.info(f" Data Types of Variables : {df.dtypes}")
