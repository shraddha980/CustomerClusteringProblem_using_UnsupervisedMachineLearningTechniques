...
transformer = pickle.load(open('Segmentation-Prediction-Project-main/transformer.pkl', 'rb'))

st.title("Segmentation Premium Prediction")
...
if st.button("Show Result"):
    st.header(f" Segmentation Prediction is  {round(y_pred[0],2)} INR")